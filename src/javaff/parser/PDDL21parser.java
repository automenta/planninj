...
public class PDDL21parser implements PDDL21parserConstants {
	protected static final UngroundProblem UP = new UngroundProblem();
...
// ***************************************************
	...
	final public void parseInitEl() throws ParseException {
		...
		if (jj_2_79(20)) {
			...
			t1 = jj_consume_token(NUMBER);
			jj_consume_token(CLOSE);
			UP.funcValues.put(nf, BigDecimal.valueOf(Double.parseDouble(t1.toString())));
		} else {
			jj_consume_token(-1);
			throw new ParseException();
		}
...
// **********************************
	...
	final public int parseOptimization() throws ParseException {
		...
		if (t1.toString().equals("minimize")) {
			if (true) return Metric.MINIMIZE;
		} else if (t1.toString().equals("maximize")) {
			if (true) return Metric.MAXIMIZE;
		} else {
			if (true) return -1;
		}
		throw new Error("Missing return statement in function");
	...
	private boolean jj_3_9() {
		return jj_scan_token(NON_HANDLED_LABELS);
	}
	...
	private boolean jj_3_8() {
		return jj_scan_token(REQUIREMENT_LABELS);
	}
	...
	private boolean jj_3R_57() {
		return jj_scan_token(OPTIMIZATION);
	}

	private boolean jj_3_60() {
		return jj_scan_token(BINARY_COMP);
	}
	...
	private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == jj_endpos + 1) {
            ...
            for (Object jjExpentry : jj_expentries) {
                int[] oldentry = (int[]) jjExpentry;
	...
	private static class TypedList {
		...
		public final Map types = new HashMap();    // Maps strings onto Types
